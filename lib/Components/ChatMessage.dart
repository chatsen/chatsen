              ...
              children: [
                ...
                WidgetSpan(
                  child: Padding(
                    ...
                    child: InkWell(
                      onTap: () async => launch(token.data), //'https://cdn.imgproxify.com/image?url=${Uri.encodeComponent(token.data)}'),
                      child: NetworkImageW(token.data), //'https://cdn.imgproxify.com/image?url=${Uri.encodeComponent(token.data)}'),
                    ),
                  ),
                ),
                TextSpan(text: '\n'),
