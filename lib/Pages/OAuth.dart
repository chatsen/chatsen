...
class _OAuthPageState extends State<OAuthPage> {
  ...
  void initState() {
    ...
    _controller = WebViewController()
      ...
      ..loadRequest(Uri.parse('https://id.twitch.tv/oauth2/authorize?client_id=vvxbprk8sfufgzd7k9wwr1478znf7b&redirect_uri=https://chatsen.app/oauth&response_type=token&scope=' +
          [
            // Chat
            'chat:edit',
            'chat:read',
